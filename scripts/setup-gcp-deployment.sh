...
echo "🚀 L0180 GCP Deployment Setup"
echo "=============================="
...
if [ "$DEPLOY_NOW" = "y" ]; then
    ...
    if command -v docker &> /dev/null; then
        ...
        docker build -t gcr.io/$PROJECT_ID/l0180:initial .
        docker push gcr.io/$PROJECT_ID/l0180:initial

        # Deploy to Cloud Run
        gcloud run deploy l0180 \
            --image gcr.io/$PROJECT_ID/l0180:initial \
            --platform managed \
            --region us-central1 \
            --port 50180 \
