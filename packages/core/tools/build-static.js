// Emits L0180's public static assets into dist/static/. As a child of L0000, L0180 merges
// inherited content from its parent:
//   - lexicon.json: the merged lexicon (base + L0180) — already merged in src/lexicon.ts.
//     (the legacy lexicon.js request path is aliased to it by the API server.)
//   - instructions.md: parent (L0000) instructions concatenated with L0180's.
// The rest (spec.html, language-info.json, scope.json, schema.json, template.gc,
// usage-guide.md) are L0180's own.
...
// 1. lexicon — merged (base + L0180) as plain JSON in lexicon.json. No lexicon.js is written:
...
// 3. instructions.md — parent (L0000) instructions + L0180's. Resolve the parent's
...
// 4. Copy L0180's own verbatim spec assets.
