...
export { scoreInteraction, scoreChoice, scoreItem, selectedIds } from "./scoring";
export type { Score, Validation, ItemValidation, ScoringMode, OptionValidation, OptionOutcome } from "./scoring";
